      ...
      <Layout>
        ...
        <div className="px-6 pt-8 pb-6 flex flex-col">
          ...
          <p className="my-3 lg:my-5 lg:px-64 text-justify">
            This role is the technology expert. The Tech is equipped with a cybernetic augmentation that enables a direct human-machine interface.
            This individual can interact with and manipulate machines with a passing thought.
          </p>
...
export async function getServerSideProps() {
  ...
  items.forEach(item => {
    ...
    if (!thisItem.hasOwnProperty('visible') || !thisItem.visible || (isProd && !thisItem.live) || thisItem.role !== 'tech') {
      return
    }
